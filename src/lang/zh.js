export default {
	...
	auth2: {
		...
		back: '证件照背面',
		hand: '上传手持证件照',
		tip2: '请提供一张您手持证件照的照片，在同张照片中也要包含有“SMAEX”、日期和您的签名的注释。请确保您的脸部清晰可见，且所有证件详细信息都清楚可读',
		face: '面部清晰可见无遮挡',
		clearly: '照片清晰可见',
		notes: '带有[SMAEX]的文字注释',
		...
		tip4: ' 请提供一张您本人的SMAEX账号的资产明细截图或者照片，图片中包含您的账户名、uid、持仓详情、当前时间。所有信息清晰可读。',
		screenshot: '上传资产截图信息',
		nowLever: '当前认证等级',
		authCard: '身份证',
		hu: '护照',
	...
	tpc: {
		...
		nodata: '暂无数据',
		search: '搜索',
		tips: '*当前页展示内容为项目方自行填写，SMAEX不对此内容真实性负责',
		time: '发行时间',
		total: '发行总量',
		circulation: '代币流通量',
		price: '发行价',
