export default {
	...
	login: {
		...
		welcome: 'Log in with your SMAEX account',
	...
	auth2: {
		...
		tip2: 'Please provide a photo of you with the card in your hand. In the same photo, should also include "SMAEX", date and your signature. Please make sure that your face is visible and that all document details are readable',
		face: 'The face is clearly visible without occlusion',
		clearly: 'The photos are clearly visible',
		notes: 'photo with [SMAEX] text',
		...
		tip4: ' Please provide a screenshot or photo of the assets of your SMAEX account, including your account name, uid, position details and current time. All the information is clearly readable.',
	...
	tpc: {
		...
		nodata: 'No data',
		search: 'Search',
		tips: '*The content displayed on the current page is filled out by the project party, and SMAEX is not responsible for the authenticity of the content',
		time: 'Issue time',
