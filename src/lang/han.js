export default {
	...
	auth2: {
		...
		back: '증명서 뒷면',
		hand: '소지품 사진을 업로드하다',
		tip2: '동일 사진에 " SMAEX ", 날짜 및 서명이있는 주석이 포함 된 사진을 제공 하는 사진을 제공 합니다. 얼굴이 선명 하고 모든 문서 상세 정보를 읽을 수있는지 확인 하 십시오',
		face: '또렷하고 또렷한 얼굴',
		clearly: '사진 선명도',
		notes: '[SMAEX]가 있는 문자 주석',
		...
		tip4: ' 본인의 SMAEX 계정에 대한 자산 세부 정보 캡쳐 또는 사진을 입력 하 십시오. 사진에는 계정이름, uid, 토너 카트리지 상세 정보, 현재 시간이 포함 되 어있 습니다. 모든 정보를 읽을 수있 습니다.',
	...
	tpc: {
		...
		nodata: '데이터 없음',
		search: '수색',
		tips: '*현재 페이지에 표시된 내용은 프로젝트 측에서 직접 작성하며, SMAEX는 이에 대한 신뢰성에 대한 책임을 지지 않습니다',
		time: '발행 날짜',
		total: '총 발행',
		circulation: '토큰 유통량',
		price: '발행가격',
