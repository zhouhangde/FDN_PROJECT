export default {
	...
	home: {
		...
		atrade: 'SMAEXグローバルステーションのアカウントを登録して、取引の旅を開始します。',
		Gcoin: 'SMAEX',
	...
	auth2: {
		...
		tip2: '証明書を持って撮った写真を提供してください。同じ写真にも「SMAEX」と日付とサインのコメントが含まれています。顔がよく見えるようにしてください。証明書の詳細は全部分かります',
		face: '顔がくっきりと見える',
		clearly: '写真が鮮明に見える',
		notes: '[SMAEX]の文字コメントが付いています',
		...
		tip4: ' ご本人のSMAEXアカウントの資産明細のスクリーンショットまたは写真を提供してください。画像にはお客様の口座名、uid、在庫保持の詳細、現在の時間が含まれています。すべての情報をクリアして読むことができます。',
	...
	tpc: {
		...
		nodata: 'データがありません',
		search: '索',
		tips: '*現在のページの展示内容はプロジェクト側自身で記入して、SMAEXはこの内容の真実性に責任を負わない',
		time: '発行時間',
		total: '総発行量',
		circulation: 'トークンフロー',
		price: '発行価格',
