            ...
            <div class="plr40 ptb20 radius10 mb10" style="background:#e0f2ff;">
                    ...
                    <div class="mt20 flex alcenter cor2">
                        <div class=" radius4 flex alcenter flex1 mr30 radius5 hidden">
                            <div class=" flex1 ptb10 tc bgWhite">https://www.smaex.io/#/components/register?code={{invite_code}}</div>
    ...
    methods:{
        ...
        copy_link(){
            ...
            var clipboard = new Clipboard(".copy_link", {
                text: function() {
                return (
                    'https://www.smaex.io/#/components/register?code='+that.invite_code
                );
                }
            });
            clipboard.on("success", function(e) {
